...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['virgin', 0.2], //From 0% to 19%
		['boo you suck', 0.4], //From 20% to 39%
		['no', 0.5], //From 40% to 49%
		['a', 0.6], //From 50% to 59%
		['oh ok', 0.69], //From 60% to 68%
		['funny number', 0.7], //69%
		['papayas', 0.8], //From 70% to 79%
		['yes', 0.9], //From 80% to 89%
		['the w', 1], //From 90% to 99%
		['chad', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("Open 24 Display St.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		scoreTxt.setFormat(Paths.font("Open 24 Display St.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		scoreTxt.scrollFactor.set();
		scoreTxt.borderSize = 1.25;
		scoreTxt.visible = !ClientPrefs.hideHud;
		add(scoreTxt);

		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "LOSER MODE ACTIVE", 32);
		botplayTxt.setFormat(Paths.font("Open 24 Display St.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
